...
#-----------------------------------Main_frame-----------------------------
    ...
    #select_frame(Fixed)
    select_frame = ttk.Frame(frame,height=10)
    ...
    #        edit_mode = 2
    #button_auto = ttk.Button(select_frame,text='Auto',width=10)
    #button_manual = ttk.Button(select_frame,text='Manual',width=10)
    ...
    button_event.ChangeModeButtons(
        select_frame,
        MODE_list,
        active_frame_list = [[second_frame_auto,third_frame_auto],[second_frame_manual,third_frame_manual]]
    )
    
    button_event.ChangeModeButtons(
        second_frame_manual,
        Transport_list,
        active_frame = third_frame_manual_frames
    )
